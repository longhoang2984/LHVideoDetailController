...
class FacebookViewController: LHVideoDetailController {
    ...
    override func viewDidLoad() {
        ...
        self.setupViews(withVideoView: moviePlayer.view, videoViewHeight: UIScreen.main.bounds.size.height)//, minimizeButton: minimizeButton)
        setupMoviePlayer()
    ...
    func setupMoviePlayer() {
        // setupMovie
        let url = NSURL.fileURL(withPath: Bundle.main.path(forResource: "Facebook", ofType: "mp4")!)
